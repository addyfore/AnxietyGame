...
public class Player : MonoBehaviour
{
    ...
    //below is the code for the scroll wheel to cycle through spells
        ...
        if (spellSelectMouseScrollWheel >= 120) //scroll wheel gets moved up, moving through the spell list in a positive direction.
        {
        ...
        else if (spellSelectMouseScrollWheel <= -120) //scroll wheel gets moved down, moving through the spell list in a negative direction.
        {
